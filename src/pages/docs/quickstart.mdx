...
curl -O https://raw.githubusercontent.com/golemcloud/golem/master/docker-examples/local-postgres/compose.yaml -O  https://raw.githubusercontent.com/golemcloud/golem/master/docker-examples/local-postgres/.env
